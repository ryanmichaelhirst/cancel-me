...
const token = 'AAAAAAAAAAAAAAAAAAAAADjvKwEAAAAAvEscVU9JjtPo7RU%2Bt0vfb3%2BDEJU%3DjSXfEiPQjSPdpHYep5mftfWaqt6MQw8iErusKOjnOIc0iUimJX'
const authClient = new auth.OAuth2Bearer(token)
export const twitterClient = new Client(authClient);

// https://developer.twitter.com/en/docs/twitter-api/tweets/timelines/api-reference/get-users-id-tweets
const fetchTweetsByUserId = async ({userId, opts }: { userId: string, opts: TwitterParams<usersIdTweets> }) => {
